#!/usr/bin/env python3
"""Write the Step 7E dynamic-occlusion policy freeze report."""
...
IMPACT_PATH = Path("/tmp/step7e_observability_selected_policy_impact_v01.json")
...
def main() -> int:
    ...
    if impact["affected_by_winning_cell_candidate_count"] != 361:
        raise RuntimeError("frozen policy impact count changed")
    ...
    print("baseline-visible changes:", 361)
