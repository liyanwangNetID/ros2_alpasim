...
from step4.profile_lateral_action_features import (
    corridor_heading_at_distance,
    cumulative_trajectory_distances,
    relative_heading_features,
    trajectory_path_length,
)
from step4.natural_lane_corridor import CorridorPoint, NaturalLaneCorridor
...
class LateralCorridorMathTests(unittest.TestCase):
