...
from step4.meta_action_rules_v02 import classify_lateral, classify_longitudinal
...
class LateralRuleTests(unittest.TestCase):
    ...
    def test_branch_relative_turn(self):
        ...
        value["filtered_path_signed_heading_change_rad"] = (
            math.radians(-15)
        )
        value["final_relative_y_m"] = -3.0
